...
import { mostrarTarea, editarTarea, listaTareas } from './ListaTareas';
...
export function menuAgregarTarea(tarea : Tarea){
...
function estaIndice(array: number[], index: number){
...
export function verDetalles(indices: number[]){
    let index: number, editar:String;
...
export function mostrarCoincidencias(array:number[], b:number){
